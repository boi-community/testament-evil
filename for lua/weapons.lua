...
gunmod_WEP.WeaponTypes = {
  ...
  machinepistol = {
    ...
    name = "Machine Pistol", type = 'pistol',
    base = 'machinepistol',
  ...
  pumpactionshotgun = {
    meta = {parent = 'defaultauto', forsale = true, rank = 1},
    name = 'Pump-Action Shotgun', type = 'shotgun',
  ...
  assaultshotgun = {
    meta = {parent = 'defaultcharge', forsale = true, rank = 2},
    name = 'Assault Shotgun', type = 'shotgun',
    base = 'assaultshotgun',
  ...
  autoshotgun = {
    meta = {parent = 'defaultauto', forsale = true, rank = 3},
    name = 'Auto Shotgun', type = 'shotgun',
    base = 'autoshotgun',
  ...
  assaultrifle = {
    meta = {parent = 'defaultauto', forsale = true, rank = 1},
    name = 'Assault Rifle', type = 'automatic',
    base = 'assaultrifle',
  ...
  rustytypewriter = {
    ...
    name = "Rusty Typewriter", type = 'automatic',
  ...
  dualrevolvers = {
    meta = {parent = 'defaultauto', forsale = true, rank = 1},
    name = "Dual Revolvers", type = 'magnum',
    base = 'dualrevolvers',
    ...
    sndshoot = {snd.shoot.hand.light3, .7, 1.2}, sndrl1 = {snd.cock.start2, 1, 1}, sndrl2 = {snd.misc.spin, 1, 1},
    sndshell = {snd.cock.shell2, 1, 1},
  },
  machinegun = {
    meta = {parent = 'defaultauto', forsale = true, rank = 3},
    name = "Machine Gun", type = 'machine gun',
    base = 'machinegun',
  ...
  grenadelauncher = {
    meta = {parent = 'defaultauto', forsale = true, rank = 1},
    name = "Grenade Launcher", type = 'special weapon',
  ...
  flamethrower = {
    meta = {parent = 'defaultauto', forsale = true, rank = 2},
    name = "Flamethrower", type = 'special weapon',
    base = 'flamethrower',
  ...
  rpg = {
    meta = {parent = 'defaultcharge', forsale = true, rank = 2},
    name = "Rocket Launcher", type = 'special weapon',
    base = 'rocketlauncher',
  ...
  chainsaw = {
    meta = {parent = 'defaultauto', forsale = true, rank = 2},
    name = "Chainsaw", type = 'special weapon',
    base = 'chainsaw',
  ...
  fam_base = {
    ...
    ammotype = EAM.pistol,
    skill = gCON.Id.WSQuad,
    as = {damage = 3.5 - 3.5, maxfiredelay = 20 - 10},
    knockback = .2,
    screenshake = 0, screenshakecrit = 0, screenshakenocharge = 0,
    spreadmax = 0, spreadmin = 0, recoil = 2,
    famrangemax = 200, famrangemin = 30, famrangepref = 80, fancritskill = .15,
    clipsize = 50, reloadtime = 50, spreadmax = 10, knockback = .02,
    ...
    upgrade = {{
      ...
      add = {copies = {0, 0, 0, 1}},
      set = {alternatinggunfire = 2},
    }},

    sndshoot = {snd.shoot.hand.light, .7, 1.5}, sndrl1 = {snd.cock.start4, .7, 1.5}, sndrl2 = {snd.cock.finish4, .7, 1.5},
    sndlaser = {snd.shoot.laser.light, .4, 1.5},
  },
  fam_bobby = {
    famindex = 1,
    meta = {parent = 'fam_base'},
    base = 'handgun',

    firemode = EFM.charge,
    knockback = .2,
    chargescale = true, chargemin = .5, critbonus = 2,
    critframes = 15, critconfuse = 45,
    famcritskill = .15,
  },
  fam_maggy = {
    famindex = 7,
    ...
    tf = {{variant = TearVariant.BLOOD}},
    as = {damage = .5 - 3.5, maxfiredelay = 4 - 10},
    knockback = .01,
  },
  fam_robo = {
    famindex = 6,
  ...
  fam_robo2 = {
    famindex = 53,
    meta = {parent = 'fam_robo'},

    copies = {0, 0, 0, 2},
    laser = 2, famgotoaim = true,
    alternatinggunfire = 2,
  },
  fam_gish = {
    famindex = 4,
  ...
  fam_steven = {
    ...
    --flag = TearFlags.TEAR_HOMING,
    tf = {{color = Color(1, 0, 1, 1, 0, 0, 0)}},
    lasersight = true, laserguide = true,
    ms = {range = 3},
  },
  --[[fam_demon = {
    famindex = 2,
    ...
    as = {maxfiredelay = 20 - 10, range = 10},
    pellets = 5, fanshot = true, spreadmax = 40, spreadmin = 40,
    damagemult = 3/5,-- maxchamber = 3, chargedamage = true,
    famrangemax = 150, shakemod = 0,
  },--]]
  fam_ghost = {
    famindex = 9,
    meta = {parent = 'fam_bobby'},
    base = 'boltsniper',

    tf = {{flag = TearFlags.TEAR_SPECTRAL, color = Color(1, 1, 1, .5, 100, 100, 100)}},
    as = {maxfiredelay = 30, damage = 7 - 10},
    ms = {range = 2}, velocity = 2,

    famrangemax = 400, famrangemin = 80, famrangepref = 200,
    famcritskill = .35, famignorecol = true,
  },
  fam_harlequin = {
    famindex = 10,
    meta = {parent = 'fam_base'},
    ...
    tf = {{variant = TearVariant.BLOOD}},
    pellets = 2, fanshot = true, spreadmin = 30, spreadmax = 30,
    famrangemax = 150,
  },
  fam_rainbow = {
    famindex = 11,
    ...
    as = {maxfiredelay = 10 - 10, damage = 1.5 - 3.5},

    tf = {
      {variant = TearVariant.BLOOD, damagemult = 1.5, chance = .1},
      {variant = TearVariant.TOOTH, damagemult = 2, chance = .1},
      {variant = TearVariant.FIRE_MIND, flag = TearFlags.TEAR_BURN, chance = .1},
      {variant = TearVariant.SCYTHE, damagemult = 2, chance = .1},
      {variant = TearVariant.NAIL, damagemult = 1.5, chance = .1},
      {variant = TearVariant.GLAUCOMA, flag = TearFlags.TEAR_PERMANENT_CONFUSION, chance = .1},
      {variant = TearVariant.BONE, flag = TearFlags.TEAR_BONE, chance = .1},
    },
  },
  fam_holywater = {
    famindex = 25,
  ...
  fam_brimstone = {
    ...
    --[[brimstone = true, firemode = EFM.charge, maxchamber = 7, recoil = 1,
    tf = {{variant = TearVariant.BLOOD, flag = TearFlags.TEAR_PIERCING}},
    spreadmin = 15, spreadmax = 15,
    sp = {ESP.fullcharge, ESP.brimstone, ESP.multiknock},
    damagemult = 1.666, knockback = .3,--]]
  },
  fam_sissylonglegs = {
    famindex = 66,
    meta = {parent = 'fam_base'},

    tf = {{flag = TearFlags.TEAR_CHARM, chance = .05}},
    famnoposition = true,
...
for i, wep in pairs(gWEP.WeaponTypes) do
  if wep.famindex then
    gunmod_WEP.FamWeps[tostring(wep.famindex)] = i
  end
end
