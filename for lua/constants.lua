...
gunmod_CONST = {
  ...
  enstats = {
    ...
    ShotSpeed = 1,	TearHeight = -23.75, Luck = 0,
  },
}

for h = 1, 3 do
  for i, set in ipairs(gunmod_CONST.menuclr) do
    set[h] = Color(set[h][1]/255, set[h][2]/255, set[h][3]/255, 1, 0, 0, 0)
  end
end

gunmod_CONST.Sprite.Bullet:Load("gfx/uibullets.anm2", true)
gunmod_CONST.Sprite.Weapon:Load("gfx/weapon.anm2", true)
gunmod_CONST.Sprite.MenuShadow:Load("gfx/leon_menu_shadow.anm2", true)
gunmod_CONST.Sprite.MenuBack:Load("gfx/leon_menu_back.anm2", true)
gunmod_CONST.Sprite.MenuFace:Load("gfx/leon_menu_face.anm2", true)
gunmod_CONST.Sprite.MenuMask:Load("gfx/leon_menu_mask.anm2", true)
gunmod_CONST.Sprite.MenuBorder:Load("gfx/leon_menu_border.anm2", true)
