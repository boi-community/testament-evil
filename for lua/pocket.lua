local herblist = {"hg", "hy", "hr", "hgg", "hggg", "hgr", "hgy", "hry", "hgry", "hb", "hbb", "hgb", "hgbb", "hgby"}
local herbprice = {10, 25, 15, 15, 20, 20, 20, 35, 40, 15, 20, 20, 35, 40}
local herbsell = {3, 30, 6, 6, 9, 9, 33, 36, 39, 6, 9, 9, 36, 39}
...
local herbmix = {
	...
	hy = {hg = "hgy", hr = "hry", hgr = "hgry", hgb = "hgby"},
	hb = {hb = "hbb", hg = "hgb", hgb = "hgbb", hgy = "hgby"},
	hbb = {hg = "hgbb"},
	hgr = {hy = "hgry"},
	hgy = {hr = "hgry", hb = "hgby"},
	hgb = {hb = "hgbb", hy = "hgby"},
