local herblist = {"hg", "hy", "hr", "hgg", "hggg", "hgr", "hgy", "hry", "hgry"}
local herbprice = {10, 25, 15, 15, 20, 20, 20, 35, 40}
local herbsell = {3, 30, 6, 6, 9, 9, 33, 36, 39}
...
local herbmix = {
	hg = {hg = "hgg", hr = "hgr", hy = "hgy", hgg = "hggg", hry = "hgry"},
	hgg = {hg = "hggg"},
	hr = {hg = "hgr", hy = "hry", hgy = "hgry"},
	hy = {hg = "hgy", hr = "hry", hgr = "hgry"},
	hgr = {hy = "hgry"},
	hgy = {hr = "hgry"},
	hry = {hg = "hgry"}
}
